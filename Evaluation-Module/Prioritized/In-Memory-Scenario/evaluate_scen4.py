...
def main(host='5.189.144.254', port=8086):
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydataquadruple1prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydataquadruple2prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydataquadruple3prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydataquadruple4prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    plt.legend()
    # save as image
    plt.savefig('./gen_images/cpu_usage4.png')
    ...
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydataquadruple1prio\';'
    ...
    # plotting the second in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydataquadruple2prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "CPU Usage of In-Memory-Benchmark 2", color = "blue",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "CPU Usage of In-Memory-Benchmark 2", color = "blue",linewidth=7.0)

    # plotting the third in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydataquadruple3prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "CPU Usage of In-Memory-Benchmark 3", color = "green",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "CPU Usage of In-Memory-Benchmark 3", color = "green",linewidth=7.0)

    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydataquadruple4prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "CPU Usage of In-Memory-Benchmark 4", color = "black",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "CPU Usage of In-Memory-Benchmark 4", color = "black",linewidth=7.0)
    ...
    plt.legend()
    # save as Image
    plt.savefig('./gen_images/mem_usage4.png')
