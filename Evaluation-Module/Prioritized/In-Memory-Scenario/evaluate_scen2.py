...
def main(host='5.189.144.254', port=8086):
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorybenchmarkdouble1prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorybenchmarkdouble2prio\';'
    ...
    plt.legend()
    # save as image
    plt.savefig('./gen_images/cpu_usage2.png')
    ...
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorybenchmarkdouble1prio\';'
    ...
    # plotting the second in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorybenchmarkdouble2prio\';'
    ...
    plt.legend()
    # save as Image
    plt.savefig('./gen_images/mem_usage2.png')
