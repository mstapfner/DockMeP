...
def main(host='5.189.144.254', port=8086):
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-1prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-2prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-3prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-4prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-5prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-6prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    plt.legend()
    # save as image
    plt.savefig('./gen_images/cpu_usage6.png')
    ...
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-1prio\';'
    ...
    # plotting the second in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-2prio\';'
    ...
    # plotting the third in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-3prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-4prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-5prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-6prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    plt.legend()
    # save as Image
    plt.savefig('./gen_images/mem_usage6.png')
