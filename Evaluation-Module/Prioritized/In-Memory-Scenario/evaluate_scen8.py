...
def main(host='5.189.144.254', port=8086):
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-1prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-2prio\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-3prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-4prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-5prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-6prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-7prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata8-8prio\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-1prio\';'
    ...
    # plotting the second in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-2prio\';'
    ...
    # plotting the third in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-3prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-4prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-5prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-6prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 6", color = "orange",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 6", color = "orange",linewidth=7.0)

    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-7prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 7", color = "purple",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 7", color = "purple",linewidth=7.0)

    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata8-8prio\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 8", color = "lightgreen",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 8", color = "lightgreen",linewidth=7.0)
