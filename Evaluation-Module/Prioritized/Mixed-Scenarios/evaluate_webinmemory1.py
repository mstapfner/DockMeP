...
def main(host='5.189.144.254', port=8086):
    ...
    plt.figure(num='CPU Usage Web-InMemory-Benchmark 1', figsize=(14, 10), dpi=100, facecolor='w', edgecolor='k')

    # plotting the first in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorybenchmarkweb11prio\';'
    ...
    # give a title
    plt.title('CPU Usage Web-InMemory Scenario 1')
    # show legend on plot
    plt.legend()
    # save as image
    plt.savefig('./gen_images/cpu_web_inmemory1.png')


    """Memory Usage Plot generation"""
    plt.figure(num='Memory Usage Web-InMemory-Benchmark 1', figsize=(14, 10), dpi=100, facecolor='w', edgecolor='k')

    # plotting the Streaming Server
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorybenchmarkweb11prio\';'
    ...
    # give a title
    plt.title('Memory Usage Web-InMemory Scenario 1')
    # show legend on plot
    plt.legend()
    # save as Image
    plt.savefig('./gen_images/mem_web_inmemory1.png')
    plt.grid()
    ...
    plt.legend()
    # save as image
    plt.savefig('./gen_images/request_web_inmemory1.png')
    ...
    plt.legend()
    # save as image
    plt.savefig('./gen_images/requests_failed_web_inmemory1.png')
