...
def main(host='5.189.144.254', port=8086):
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-1\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-2\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-3\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-4\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-5\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-6\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-7\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-8\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-9\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata10-10\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-1\';'
    ...
    # plotting the second in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-2\';'
    ...
    # plotting the third in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-3\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-4\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-5\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-6\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-7\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 7", color = "green",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 7", color = "green",linewidth=7.0)

    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-8\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 8", color = "black",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 8", color = "black",linewidth=7.0)

    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-9\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 9", color = "red",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 9", color = "red",linewidth=7.0)

    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata10-10\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    plt.plot(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 10", color = "blue",linewidth=7.0)
    plt.scatter(xresult2, yresult2, label = "Memory Usage of In-Memory-Benchmark 10", color = "blue",linewidth=7.0)
