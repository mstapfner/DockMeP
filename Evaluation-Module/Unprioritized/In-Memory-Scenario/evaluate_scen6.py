...
def main(host='5.189.144.254', port=8086):
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-1\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-2\';'
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-3\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-4\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-5\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT value FROM "container_cpu_user_seconds_total" WHERE "name" = \'inmemorydata6-6\';'
    xresult2, yresult2 = queryCPUUtil(client, query)
    ...
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-1\';'
    ...
    # plotting the second in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-2\';'
    ...
    # plotting the third in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-3\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-4\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-5\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
    ...
    # plotting the fourth in-memory benchmark
    query = 'SELECT * FROM "container_memory_usage_bytes" WHERE "name" = \'inmemorydata6-6\';'
    xresult2, yresult2 = queryMemoryUsage(client, query)
