...
cd inMemoryTest
sudo docker create --name inmemorydataweb3prio cloudsuite/movielens-dataset
cd ..
...
cp -f ../../../Shop-Sock-Changed/docker-compose-dp-im3.yml microservices-demo/deploy/docker-compose/docker-compose.yml
