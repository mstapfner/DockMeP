...
def main():
    ...
    benchmarktimes1y = [55,115,226]
    benchmarktimes1x = [1,2,3]
    benchmarktimes2y = [115,231]
    benchmarktimes2x = [2,3]
    benchmarktimes3y = [228]
    benchmarktimes3x = [3]
    ...
    plt.figure(num='Unprioritized CPU-In-Memory benchmark runtime with different amounts of simulatenous containers', figsize=(14, 10), dpi=100, facecolor='w', edgecolor='k')
    ...
    # give a title
    plt.title('Unprioritized CPU-In-Memory benchmark runtime with different amounts of simulatenous containers')
    # show legend on plot
    plt.legend()
    # save as image
    plt.savefig('./gen_images/benchmark_runtimes_cpuinmemory.png')
